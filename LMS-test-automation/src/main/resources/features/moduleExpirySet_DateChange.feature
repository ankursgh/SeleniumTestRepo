...
#Test Case - Role - Customer Support: Programs >> Module >> Show Modules >>  Expiry Set/Data Change @LMST-726
@LMST-726 @LMST-901
...
As a Customer support, Click first link under various module types and make changes to module limits, expiry, etc.
   ...
   #Normalizarion  Automation Testing Full Course    
    ...
    Then I waited for 4 seconds.
    #***************************
    # And I clicked on the module "Automation Testing Full Course" on the user`s home page.
    #Then I waited for 2 seconds.
   # And I clicked on the start over on the module information window.
  ...
  #  And I clicked on the submit button.
   ...
   And clicked Submit button on the login page.
    ...
    #*************************************
    #Then I waited for 4 seconds.
    # And I clicked on the module "Automation Testing Refresher" on the user`s home page.
   # Then I waited for 2 seconds.
   # And I clicked on the start over on the module information window.
   #  Then I waited for 4 seconds.
   #  And I changed the frame.
